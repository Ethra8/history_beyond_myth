...
- The headings' 1st letters are in color rgb(216, 214, 214) to give it a metal-like appearance, with contours of
 ...
 - The home page has a series of small images put in line underneath the heading, all related to the Arthurian cycle. Most reappear in subsequent pages:
    + An early medieval [map of Britain](https://www.bl.uk/collection-items/matthew-paris-map-of-britain) dated 1250, from author Matthew Paris. Original source is manuscript Cotton MS Claudius D VI, kept in the National British Library, but as it is stated in the original Cotton MS Claudius D VI manuscript [description](https://www.bl.uk/manuscripts/Viewer.aspx?ref=cotton_ms_claudius_d_vi), the map was removed in year 1929, and now kept separated.
